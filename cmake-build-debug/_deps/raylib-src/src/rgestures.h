...
void UpdateGestures(void);                              // UpdatePlayerPaddle gestures detected (must be called every frame)
...
// UpdatePlayerPaddle gestures detected (must be called every frame)
