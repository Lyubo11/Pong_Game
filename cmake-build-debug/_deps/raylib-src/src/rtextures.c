...
// DrawPaddle pixel within an image
...
// DrawPaddle pixel within an image (Vector version)
void ImageDrawPixelV(Image *dst, Vector2 position, Color color)
{
    ImageDrawPixel(dst, (int)position.x, (int)position.y, color);
}

// DrawPaddle line within an image
...
// DrawPaddle circle within an image (Vector version)
void ImageDrawCircleV(Image* dst, Vector2 center, int radius, Color color)
{
    ImageDrawCircle(dst, (int)center.x, (int)center.y, radius, color);
}

// DrawPaddle circle outline within an image
...
// DrawPaddle rectangle lines within an image
...
// DrawPaddle an image (source) within an image (destination)
...
// DrawPaddle text (default font) within an image (destination)
...
// DrawPaddle text (custom sprite font) within an image (destination)
...
// UpdatePlayerPaddle GPU texture with new data
...
// UpdatePlayerPaddle GPU texture rectangle with new data
// NOTE: pixels data must match texture.format
...
//------------------------------------------------------------------------------------
// DrawPaddle a texture
void DrawTexture(Texture2D texture, int posX, int posY, Color tint)
{
    DrawTextureEx(texture, (Vector2){ (float)posX, (float)posY }, 0.0f, 1.0f, tint);
}

// DrawPaddle a texture with position defined as Vector2
void DrawTextureV(Texture2D texture, Vector2 position, Color tint)
{
    DrawTextureEx(texture, position, 0, 1.0f, tint);
}

// DrawPaddle a texture with extended parameters
...
// DrawPaddle a part of a texture (defined by a rectangle)
...
// DrawPaddle a part of a texture (defined by a rectangle) with 'pro' parameters
