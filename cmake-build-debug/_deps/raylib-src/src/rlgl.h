...
typedef struct rlRenderBatch {
    ...
    rlDrawCall *draws;          // DrawPaddle calls array, depends on textureId
    int drawCounter;            // DrawPaddle calls counter
...
RLAPI void rlDrawRenderBatch(rlRenderBatch *batch);                         // Draw render batch data (UpdatePlayerPaddle->DrawPaddle->Reset)
RLAPI void rlSetRenderBatchActive(rlRenderBatch *batch);                    // Set the active render batch for rlgl (NULL for default internal)
RLAPI void rlDrawRenderBatchActive(void);                                   // UpdatePlayerPaddle and draw internal render batch
...
RLAPI void rlUpdateVertexBuffer(unsigned int bufferId, const void *data, int dataSize, int offset);     // UpdatePlayerPaddle GPU buffer with new data
RLAPI void rlUpdateVertexBufferElements(unsigned int id, const void *data, int dataSize, int offset);   // UpdatePlayerPaddle vertex buffer elements with new data
...
RLAPI void rlUpdateTexture(unsigned int id, int offsetX, int offsetY, int width, int height, int format, const void *data);  // UpdatePlayerPaddle GPU texture with new data
...
RLAPI void rlUpdateShaderBuffer(unsigned int id, const void *data, unsigned int dataSize, unsigned int offset); // UpdatePlayerPaddle SSBO buffer data
...
void rlBegin(int mode)
{
    // DrawPaddle mode can be RL_LINES, RL_TRIANGLES and RL_QUADS
...
// DrawPaddle render batch
// NOTE: We require a pointer to reset batch and increase current buffer (multi-buffer)
void rlDrawRenderBatch(rlRenderBatch *batch)
{
#if defined(GRAPHICS_API_OPENGL_33) || defined(GRAPHICS_API_OPENGL_ES2)
    // UpdatePlayerPaddle batch vertex buffers
    //------------------------------------------------------------------------------------------------------------
    ...
    if (RLGL.State.vertexCounter > 0)
    {
        ...
        //glBufferData(GL_ARRAY_BUFFER, sizeof(float)*3*4*batch->vertexBuffer[batch->currentBuffer].elementCount, batch->vertexBuffer[batch->currentBuffer].vertices, GL_DYNAMIC_DRAW);  // UpdatePlayerPaddle all buffer
        ...
        //glBufferData(GL_ARRAY_BUFFER, sizeof(float)*2*4*batch->vertexBuffer[batch->currentBuffer].elementCount, batch->vertexBuffer[batch->currentBuffer].texcoords, GL_DYNAMIC_DRAW); // UpdatePlayerPaddle all buffer
        ...
        //glBufferData(GL_ARRAY_BUFFER, sizeof(float)*4*4*batch->vertexBuffer[batch->currentBuffer].elementCount, batch->vertexBuffer[batch->currentBuffer].colors, GL_DYNAMIC_DRAW);    // UpdatePlayerPaddle all buffer
        ...
        // {
            // UpdatePlayerPaddle vertex data
        // }
    ...
    // DrawPaddle batch vertex buffers (considering VR stereo if required)
    //------------------------------------------------------------------------------------------------------------
...
// UpdatePlayerPaddle and draw internal render batch
...
// UpdatePlayerPaddle already loaded texture in GPU with new data
...
// UpdatePlayerPaddle vertex buffer with new data
...
// UpdatePlayerPaddle vertex buffer elements with new data
// NOTE: dataSize and offset must be provided in bytes
...
// DrawPaddle vertex array
void rlDrawVertexArray(int offset, int count)
{
    glDrawArrays(GL_TRIANGLES, offset, count);
}

// DrawPaddle vertex array elements
...
// DrawPaddle vertex array instanced
...
// DrawPaddle vertex array elements instanced
...
// UpdatePlayerPaddle SSBO buffer data
